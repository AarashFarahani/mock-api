package org.apache.mockapi.servlet;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.apache.mockapi.model.HttpResponse;
...
public class MockServlet extends HttpServlet {
    private final WebObjectGenerator webObjectGenerator;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            response = this.webObjectGenerator.generate(path, method);
        } catch (Exception e) {
